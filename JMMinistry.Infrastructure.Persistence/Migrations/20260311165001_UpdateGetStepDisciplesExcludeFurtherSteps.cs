...
{
    /// <inheritdoc />
    public partial class UpdateGetStepDisciplesExcludeFurtherSteps : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                ...
                BEGIN
                    ...
                    -- Steps that require p_step_id as a prerequisite (i.e. further steps)
                    further_steps AS (
                    ...
                    WHERE NOT EXISTS (
                        ...
                        INNER JOIN "StepCompletions" fsc
                            ...
                            AND fsc."StepStatus" IN (1, 2) -- InProgress or Completed
                    )
        ...
        {
            // Restore the original function without the further-steps exclusion
            migrationBuilder.Sql("""
                CREATE OR REPLACE FUNCTION get_step_disciples(
                    p_leader_id TEXT,
                    p_step_id INTEGER,
