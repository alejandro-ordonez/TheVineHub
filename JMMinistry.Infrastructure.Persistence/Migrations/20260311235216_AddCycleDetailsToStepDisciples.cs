...
{
    /// <inheritdoc />
    public partial class AddCycleDetailsToStepDisciples : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Adding cycle_end_date and cycle_min_attendance columns (return type change requires DROP)
            ...
            // Also update get_eligible_step_disciples:
            // - match new return shape (cycle_end_date, cycle_min_attendance)
            // - include cellless people when step has no requirements
        ...
        {
            // Restore previous versions (with cycle columns but without end_date/min_attendance)
            migrationBuilder.Sql("""DROP FUNCTION IF EXISTS get_step_disciples(TEXT, INTEGER, INTEGER);""");
