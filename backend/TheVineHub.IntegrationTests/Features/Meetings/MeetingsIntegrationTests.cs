...
using TheVineHub.API.Features.Meetings.GetMeetings;
using TheVineHub.API.Features.Meetings;
using Xunit;
using FluentAssertions;

namespace TheVineHub.IntegrationTests.Features.Meetings;
...
public class MeetingsIntegrationTests : BaseIntegrationTest
{
    ...
    public async Task CreateAndGetMeetings_ShouldSuccessfullyManageMeetings()
    {
        ...
        // 2. Query meetings
        var meetings = await Mediator.Send(new GetMeetingsQuery { IsRecurrent = true });
