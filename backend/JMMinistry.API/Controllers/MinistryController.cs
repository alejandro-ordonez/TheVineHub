...
namespace JMMinistry.API.Controllers
{
    ...
    public class MinistryController(IMediator mediator) : ControllerBase
    {
        ...
        [HttpGet("{cellId}")]
        public async Task<ActionResult<CellDto>> GetCell(string cellId)
        {
            var document = HttpContext.GetDocumentClaim() ?? throw new MissingInTokenException();
        ...
        public async Task<ActionResult> GetCellAttendances(string cellId)
        {
            var document = HttpContext.GetDocumentClaim() ?? throw new MissingInTokenException();
        ...
        public async Task<ActionResult> RecordCellAttendance(string cellId, AddCellAttendanceDto cellAttendance)
        {
            var document = HttpContext.GetDocumentClaim() ?? throw new MissingInTokenException();
        ...
        public async Task<ActionResult> UpdateCellAttendance(string cellId, string attendanceId, UpdateCellAttendanceDto cellAttendance)
        {
            var document = HttpContext.GetDocumentClaim() ?? throw new MissingInTokenException();
        ...
        public async Task<ActionResult<List<DiscipleDto>>> GetDisciples(string cellId)
        {
            var document = HttpContext.GetDocumentClaim() ?? throw new MissingInTokenException();
        ...
        public async Task<ActionResult<List<BasicUserInfoDto>>> AddDisciples(string cellId, [FromBody] AddDisciplesCommand addDisciples)
        {
        ...
        public async Task<ActionResult<List<BasicUserInfoDto>>> RemoveDisciple(string cellId, string discipleId)
        {
