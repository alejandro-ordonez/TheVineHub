...
mixin _$CellDto {
 ...
 String? get id; String get name; String get description; bool get mainCell; String? get address; int get level; int get memberCount; int? get day; DateTime? get openingDate; List<LeaderInfoDto> get leaders; CityDto? get city; LocalityDto? get locality;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CellDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.mainCell, mainCell) || other.mainCell == mainCell)&&(identical(other.address, address) || other.address == address)&&(identical(other.level, level) || other.level == level)&&(identical(other.memberCount, memberCount) || other.memberCount == memberCount)&&(identical(other.day, day) || other.day == day)&&(identical(other.openingDate, openingDate) || other.openingDate == openingDate)&&const DeepCollectionEquality().equals(other.leaders, leaders)&&(identical(other.city, city) || other.city == city)&&(identical(other.locality, locality) || other.locality == locality));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,mainCell,address,level,memberCount,day,openingDate,const DeepCollectionEquality().hash(leaders),city,locality);
...
@useResult
$Res call({
 String? id, String name, String description, bool mainCell, String? address, int level, int memberCount, int? day, DateTime? openingDate, List<LeaderInfoDto> leaders, CityDto? city, LocalityDto? locality
});
...
/// Create a copy of CellDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = null,Object? description = null,Object? mainCell = null,Object? address = freezed,Object? level = null,Object? memberCount = null,Object? day = freezed,Object? openingDate = freezed,Object? leaders = null,Object? city = freezed,Object? locality = freezed,}) {
...
as DateTime?,leaders: null == leaders ? _self.leaders : leaders // ignore: cast_nullable_to_non_nullable
as List<LeaderInfoDto>,city: freezed == city ? _self.city : city // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String name,  String description,  bool mainCell,  String? address,  int level,  int memberCount,  int? day,  DateTime? openingDate,  List<LeaderInfoDto> leaders,  CityDto? city,  LocalityDto? locality)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CellDto() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.mainCell,_that.address,_that.level,_that.memberCount,_that.day,_that.openingDate,_that.leaders,_that.city,_that.locality);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String name,  String description,  bool mainCell,  String? address,  int level,  int memberCount,  int? day,  DateTime? openingDate,  List<LeaderInfoDto> leaders,  CityDto? city,  LocalityDto? locality)  $default,) {final _that = this;
switch (_that) {
case _CellDto():
return $default(_that.id,_that.name,_that.description,_that.mainCell,_that.address,_that.level,_that.memberCount,_that.day,_that.openingDate,_that.leaders,_that.city,_that.locality);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String name,  String description,  bool mainCell,  String? address,  int level,  int memberCount,  int? day,  DateTime? openingDate,  List<LeaderInfoDto> leaders,  CityDto? city,  LocalityDto? locality)?  $default,) {final _that = this;
switch (_that) {
case _CellDto() when $default != null:
return $default(_that.id,_that.name,_that.description,_that.mainCell,_that.address,_that.level,_that.memberCount,_that.day,_that.openingDate,_that.leaders,_that.city,_that.locality);case _:
  return null;
...
class _CellDto implements CellDto {
  const _CellDto({this.id, required this.name, required this.description, required this.mainCell, this.address, this.level = 1, this.memberCount = 0, this.day, this.openingDate, final  List<LeaderInfoDto> leaders = const [], this.city, this.locality}): _leaders = leaders;
...
@override@JsonKey() List<LeaderInfoDto> get leaders {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CellDto&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.mainCell, mainCell) || other.mainCell == mainCell)&&(identical(other.address, address) || other.address == address)&&(identical(other.level, level) || other.level == level)&&(identical(other.memberCount, memberCount) || other.memberCount == memberCount)&&(identical(other.day, day) || other.day == day)&&(identical(other.openingDate, openingDate) || other.openingDate == openingDate)&&const DeepCollectionEquality().equals(other._leaders, _leaders)&&(identical(other.city, city) || other.city == city)&&(identical(other.locality, locality) || other.locality == locality));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,description,mainCell,address,level,memberCount,day,openingDate,const DeepCollectionEquality().hash(_leaders),city,locality);
...
/// Create a copy of CellDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = null,Object? description = null,Object? mainCell = null,Object? address = freezed,Object? level = null,Object? memberCount = null,Object? day = freezed,Object? openingDate = freezed,Object? leaders = null,Object? city = freezed,Object? locality = freezed,}) {
...
as int,day: freezed == day ? _self.day : day // ignore: cast_nullable_to_non_nullable
as int?,openingDate: freezed == openingDate ? _self.openingDate : openingDate // ignore: cast_nullable_to_non_nullable
as DateTime?,leaders: null == leaders ? _self._leaders : leaders // ignore: cast_nullable_to_non_nullable
as List<LeaderInfoDto>,city: freezed == city ? _self.city : city // ignore: cast_nullable_to_non_nullable
as CityDto?,locality: freezed == locality ? _self.locality : locality // ignore: cast_nullable_to_non_nullable
as LocalityDto?,
  ));
...
mixin _$LeaderInfoDto {
 ...
 String? get id; String? get photoUrl; String get fullName;
/// Create a copy of LeaderInfoDto
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LeaderInfoDtoCopyWith<LeaderInfoDto> get copyWith => _$LeaderInfoDtoCopyWithImpl<LeaderInfoDto>(this as LeaderInfoDto, _$identity);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LeaderInfoDto&&(identical(other.id, id) || other.id == id)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.fullName, fullName) || other.fullName == fullName));
}
...
abstract mixin class $LeaderInfoDtoCopyWith<$Res>  {
  factory $LeaderInfoDtoCopyWith(LeaderInfoDto value, $Res Function(LeaderInfoDto) _then) = _$LeaderInfoDtoCopyWithImpl;
@useResult
$Res call({
 String? id, String? photoUrl, String fullName
});
...
/// Create a copy of LeaderInfoDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? photoUrl = freezed,Object? fullName = null,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _LeaderInfoDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _LeaderInfoDto value)  $default,){
final _that = this;
switch (_that) {
case _LeaderInfoDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _LeaderInfoDto value)?  $default,){
final _that = this;
switch (_that) {
case _LeaderInfoDto() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id,  String? photoUrl,  String fullName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LeaderInfoDto() when $default != null:
return $default(_that.id,_that.photoUrl,_that.fullName);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id,  String? photoUrl,  String fullName)  $default,) {final _that = this;
switch (_that) {
case _LeaderInfoDto():
return $default(_that.id,_that.photoUrl,_that.fullName);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id,  String? photoUrl,  String fullName)?  $default,) {final _that = this;
switch (_that) {
case _LeaderInfoDto() when $default != null:
return $default(_that.id,_that.photoUrl,_that.fullName);case _:
  return null;
...
class _LeaderInfoDto implements LeaderInfoDto {
  ...
  factory _LeaderInfoDto.fromJson(Map<String, dynamic> json) => _$LeaderInfoDtoFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$LeaderInfoDtoCopyWith<_LeaderInfoDto> get copyWith => __$LeaderInfoDtoCopyWithImpl<_LeaderInfoDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$LeaderInfoDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LeaderInfoDto&&(identical(other.id, id) || other.id == id)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.fullName, fullName) || other.fullName == fullName));
}
...
/// @nodoc
abstract mixin class _$LeaderInfoDtoCopyWith<$Res> implements $LeaderInfoDtoCopyWith<$Res> {
  factory _$LeaderInfoDtoCopyWith(_LeaderInfoDto value, $Res Function(_LeaderInfoDto) _then) = __$LeaderInfoDtoCopyWithImpl;
@override @useResult
$Res call({
 String? id, String? photoUrl, String fullName
});
...
/// Create a copy of LeaderInfoDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? photoUrl = freezed,Object? fullName = null,}) {
...
mixin _$CityDto {
 ...
 String get id; String get name; List<LocalityDto>? get localities;
...
@useResult
$Res call({
 String id, String name, List<LocalityDto>? localities
});
...
/// Create a copy of CityDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? localities = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  List<LocalityDto>? localities)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CityDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  List<LocalityDto>? localities)  $default,) {final _that = this;
switch (_that) {
case _CityDto():
return $default(_that.id,_that.name,_that.localities);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  List<LocalityDto>? localities)?  $default,) {final _that = this;
switch (_that) {
case _CityDto() when $default != null:
return $default(_that.id,_that.name,_that.localities);case _:
  return null;
...
/// Create a copy of CityDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? localities = freezed,}) {
