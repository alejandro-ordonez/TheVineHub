...
mixin _$DiscipleshipNoteEntryDto {
 ...
 String get id; String? get content; DateTime get date; DateTime get createdAt; String get noteId; String? get authorId;
...
@useResult
$Res call({
 String id, String? content, DateTime date, DateTime createdAt, String noteId, String? authorId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? content,  DateTime date,  DateTime createdAt,  String noteId,  String? authorId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiscipleshipNoteEntryDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? content,  DateTime date,  DateTime createdAt,  String noteId,  String? authorId)  $default,) {final _that = this;
switch (_that) {
case _DiscipleshipNoteEntryDto():
return $default(_that.id,_that.content,_that.date,_that.createdAt,_that.noteId,_that.authorId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? content,  DateTime date,  DateTime createdAt,  String noteId,  String? authorId)?  $default,) {final _that = this;
switch (_that) {
case _DiscipleshipNoteEntryDto() when $default != null:
return $default(_that.id,_that.content,_that.date,_that.createdAt,_that.noteId,_that.authorId);case _:
  return null;
