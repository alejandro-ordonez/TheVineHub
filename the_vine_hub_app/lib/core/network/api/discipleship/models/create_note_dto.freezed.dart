...
mixin _$CreateNoteDto {
 ...
 String get title; String get description; List<String> get categories;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CreateNoteDto&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other.categories, categories));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,description,const DeepCollectionEquality().hash(categories));
...
/// Create a copy of CreateNoteDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? description = null,Object? categories = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String title,  String description,  List<String> categories)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CreateNoteDto() when $default != null:
return $default(_that.title,_that.description,_that.categories);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String title,  String description,  List<String> categories)  $default,) {final _that = this;
switch (_that) {
case _CreateNoteDto():
return $default(_that.title,_that.description,_that.categories);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String title,  String description,  List<String> categories)?  $default,) {final _that = this;
switch (_that) {
case _CreateNoteDto() when $default != null:
return $default(_that.title,_that.description,_that.categories);case _:
  return null;
...
class _CreateNoteDto implements CreateNoteDto {
  const _CreateNoteDto({required this.title, this.description = '', final  List<String> categories = const []}): _categories = categories;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CreateNoteDto&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&const DeepCollectionEquality().equals(other._categories, _categories));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,title,description,const DeepCollectionEquality().hash(_categories));
...
/// Create a copy of CreateNoteDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? description = null,Object? categories = null,}) {
