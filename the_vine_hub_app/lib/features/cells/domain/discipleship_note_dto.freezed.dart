...
mixin _$DiscipleshipNoteDto {
 ...
 int get noteId; String? get title; String? get description; int? get noteStatus; DateTime get createdAt; List<String>? get categories; String? get discipleId; String? get leaderId; List<DiscipleshipNoteEntryDto>? get entries;
...
@useResult
$Res call({
 int noteId, String? title, String? description, int? noteStatus, DateTime createdAt, List<String>? categories, String? discipleId, String? leaderId, List<DiscipleshipNoteEntryDto>? entries
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int noteId,  String? title,  String? description,  int? noteStatus,  DateTime createdAt,  List<String>? categories,  String? discipleId,  String? leaderId,  List<DiscipleshipNoteEntryDto>? entries)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DiscipleshipNoteDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int noteId,  String? title,  String? description,  int? noteStatus,  DateTime createdAt,  List<String>? categories,  String? discipleId,  String? leaderId,  List<DiscipleshipNoteEntryDto>? entries)  $default,) {final _that = this;
switch (_that) {
case _DiscipleshipNoteDto():
return $default(_that.noteId,_that.title,_that.description,_that.noteStatus,_that.createdAt,_that.categories,_that.discipleId,_that.leaderId,_that.entries);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int noteId,  String? title,  String? description,  int? noteStatus,  DateTime createdAt,  List<String>? categories,  String? discipleId,  String? leaderId,  List<DiscipleshipNoteEntryDto>? entries)?  $default,) {final _that = this;
switch (_that) {
case _DiscipleshipNoteDto() when $default != null:
return $default(_that.noteId,_that.title,_that.description,_that.noteStatus,_that.createdAt,_that.categories,_that.discipleId,_that.leaderId,_that.entries);case _:
  return null;
