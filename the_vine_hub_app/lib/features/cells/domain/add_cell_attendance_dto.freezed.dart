...
mixin _$AddCellAttendanceDto {
  ...
  $AddCellAttendanceDtoCopyWith<AddCellAttendanceDto> get copyWith =>
      _$AddCellAttendanceDtoCopyWithImpl<AddCellAttendanceDto>(
          this as AddCellAttendanceDto, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(disciples), notes);
...
abstract mixin class $AddCellAttendanceDtoCopyWith<$Res> {
  factory $AddCellAttendanceDtoCopyWith(AddCellAttendanceDto value,
          $Res Function(AddCellAttendanceDto) _then) =
      _$AddCellAttendanceDtoCopyWithImpl;
  @useResult
  $Res call({List<String>? disciples, String? notes});
}
...
extension AddCellAttendanceDtoPatterns on AddCellAttendanceDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AddCellAttendanceDto value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(List<String>? disciples, String? notes)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AddCellAttendanceDto() when $default != null:
        return $default(_that.disciples, _that.notes);
      case _:
        return orElse();
    }
  }
...
class _AddCellAttendanceDto implements AddCellAttendanceDto {
  const _AddCellAttendanceDto({final List<String>? disciples, this.notes})
      : _disciples = disciples;
  factory _AddCellAttendanceDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AddCellAttendanceDtoCopyWith<_AddCellAttendanceDto> get copyWith =>
      __$AddCellAttendanceDtoCopyWithImpl<_AddCellAttendanceDto>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AddCellAttendanceDtoToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _AddCellAttendanceDto &&
  ...
  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_disciples), notes);
...
/// @nodoc
abstract mixin class _$AddCellAttendanceDtoCopyWith<$Res>
    implements $AddCellAttendanceDtoCopyWith<$Res> {
  factory _$AddCellAttendanceDtoCopyWith(_AddCellAttendanceDto value,
          $Res Function(_AddCellAttendanceDto) _then) =
      __$AddCellAttendanceDtoCopyWithImpl;
  @override
  @useResult
  $Res call({List<String>? disciples, String? notes});
}
