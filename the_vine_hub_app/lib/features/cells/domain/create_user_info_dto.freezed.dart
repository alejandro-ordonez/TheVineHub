...
mixin _$CreateUserInfoDto {
  ...
  $CreateUserInfoDtoCopyWith<CreateUserInfoDto> get copyWith =>
      _$CreateUserInfoDtoCopyWithImpl<CreateUserInfoDto>(
          this as CreateUserInfoDto, _$identity);
...
abstract mixin class $CreateUserInfoDtoCopyWith<$Res> {
  factory $CreateUserInfoDtoCopyWith(
          CreateUserInfoDto value, $Res Function(CreateUserInfoDto) _then) =
      _$CreateUserInfoDtoCopyWithImpl;
  @useResult
  $Res call(
      {String document,
      String name,
...
extension CreateUserInfoDtoPatterns on CreateUserInfoDto {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CreateUserInfoDto value)? $default, {
...
class _CreateUserInfoDto implements CreateUserInfoDto {
  const _CreateUserInfoDto(
      ...
      this.accessType = 0});
  factory _CreateUserInfoDto.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CreateUserInfoDtoCopyWith<_CreateUserInfoDto> get copyWith =>
      __$CreateUserInfoDtoCopyWithImpl<_CreateUserInfoDto>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CreateUserInfoDtoToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CreateUserInfoDtoCopyWith<$Res>
    implements $CreateUserInfoDtoCopyWith<$Res> {
  factory _$CreateUserInfoDtoCopyWith(
          _CreateUserInfoDto value, $Res Function(_CreateUserInfoDto) _then) =
      __$CreateUserInfoDtoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String document,
