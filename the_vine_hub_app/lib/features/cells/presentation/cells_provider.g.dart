...
final class CellsProvider extends $FunctionalProvider<AsyncValue<List<CellDto>>,
        List<CellDto>, FutureOr<List<CellDto>>>
...
final class CellDetailsProvider
  ...
  CellDetailsProvider._(
      {required CellDetailsFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class CellDisciplesProvider extends $FunctionalProvider<
  ...
  CellDisciplesProvider._(
      {required CellDisciplesFamily super.from, required String super.argument})
      : super(
          retry: null,
...
final class LocationDataProvider extends $FunctionalProvider<
        AsyncValue<List<CityDto>>, List<CityDto>, FutureOr<List<CityDto>>>
